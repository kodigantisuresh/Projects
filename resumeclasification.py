...
if menu_id == 'Home':
    ...
    with tab1:
        ...
        with col1:
            ...
            st.markdown('<img align="right" alt="code"  height="200" width="200" src = "https://stat                        ic.wixstatic.com/media/15e6c3_8f8cac375de143dc9d1d552090d975cf~mv2.gif">', unsafe_allow_html=True)
...
def extract_skills(resume_text):
    ...
    data = pd.read_csv("C:/Users/ACER/Downloads/skills.csv") 
...
if menu_id == 'Data Analysis':
    ...
    with tab1:
        ...
        with col1:
            ...
            st.image('C:/Users/ACER/Documents/Images?raw=true')
...
if menu_id == 'Resume Details':
    ...
    def extract_skills(resume_text):
            ...
            # reading the csv file
            data = pd.read_csv("C:/Users/ACER/Documents/Resume Analyser/skills.csv") 
    ...
    st.subheader('Upload Resume (Single File)')
